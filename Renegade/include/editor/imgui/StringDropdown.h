...
public:
	...
	StringDropdown(T a_InitialValue, std::vector<T> a_Options, std::vector<std::string> a_TextValues) : m_Value(a_InitialValue), m_Options(a_Options), m_TextValues(a_TextValues)
	{
